...
public class textformattingActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.textformatting);
        //--------------------------
        mycheckBox_Underline=(CheckBox)findViewById(R.id.checkBox_textformatting_Underline);
        mycheckBox_InvertColor=(CheckBox)findViewById(R.id.checkBox_textformatting_InvertColor);
        mycheckBox_Emphasized=(CheckBox)findViewById(R.id.checkBox_textformatting_Emphasized);
        mycheckBox_UpsideDown=(CheckBox)findViewById(R.id.checkBox_textformatting_UpsideDown);
        myeditText_LeftMargin=(EditText)findViewById(R.id.editText_textformatting_LeftMargin);
        myeditText_TextToPrint=(EditText)findViewById(R.id.editText_textformatting_TextToPrint);
        //--------------------------
        myspinner_Height = (Spinner) findViewById(R.id.spinner_textformatting_Height);
        ...
        myspinner_Width = (Spinner) findViewById(R.id.spinner_textformatting_Width);
        ...
        myspinner_Alignment = (Spinner) findViewById(R.id.spinner_textformatting_Alignment);
    ...
    public void PrintText_textformatting(View view)
    {
		...
		if(Main.isLAN) {
			PrinterFunctionsLAN.PrintText(
					...
					value_LeftMargin,
					value_Alignment,
					myeditText_TextToPrint.getText().toString());
    ...
    public void Help_textformatting(View view)
    {
    	String helpString = 
    			"<body>" +
    	    	"<MainTitle>int PrintText(String portName,<br/>" +
    	    	"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
    	    	"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
    	    	"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
    	    	"int portSettings,<br/>" +
